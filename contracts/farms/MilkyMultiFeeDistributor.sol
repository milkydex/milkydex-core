...
import "../interfaces/ILiquidityMiningFund.sol";
import "../interfaces/IWETH.sol";

// Based on Geist's MultiFeeDistribution
contract MilkyMultiFeeDistributor is ReentrancyGuard, Ownable {
    ...
    ILiquidityMiningFund public stakingTokenFund;
    IWETH public weth;
    ...
    uint256 public constant lockDuration = rewardsDuration * 12; // 12 weeks
    ...
    constructor(
        ...
        stakingTokenFund = ILiquidityMiningFund(_stakingTokenFund);
        weth = IWETH(_weth);
    ...
    function addMinter(address _newMinter) external onlyOwner {
        require(_newMinter != address(0), "MultiFeeDistribution::addMinter: Invalid address");
        require(!minters[_newMinter], "MultiFeeDistribution::addMinter: Minter existed");
    ...
    function removeMinter(address _minter) external onlyOwner {
        require(minters[_minter], "MultiFeeDistribution::addMinter: Minter not found");
